...
比如通过模块`a-file`上传了一张图片，该图片在服务器的实际存储文件名为：`{publicDir}/{instanceId}/file/image/2019-11-18/6fb2784415f949948355ef843d78459a-126_0.jpg`，而对外提供的下载链接是：`https://admin.cabloy.com/api/a/file/file/download/46c68dae591b41c3bd2181facc8d0af9.jpg`。前端通过该下载链接可以直接下载图片，但是并不知道该图片在服务器存储的真实位置和真实名称
